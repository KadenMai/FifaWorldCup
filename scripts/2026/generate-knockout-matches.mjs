...
const FIXTURES = [
  ...
  { id: 75, round: 'r32', date: '2026-06-29', time: '19:00', timezone: 'America/Monterrey', stadiumId: 'bbva' },
  { id: 76, round: 'r32', date: '2026-06-29', time: '12:00', timezone: 'America/Chicago', stadiumId: 'nrg-stadium' },
  { id: 77, round: 'r32', date: '2026-06-30', time: '17:00', timezone: 'America/New_York', stadiumId: 'metlife-stadium' },
  { id: 78, round: 'r32', date: '2026-06-30', time: '12:00', timezone: 'America/Chicago', stadiumId: 'att-stadium' },
  { id: 79, round: 'r32', date: '2026-06-30', time: '19:00', timezone: 'America/Mexico_City', stadiumId: 'azteca' },
  { id: 80, round: 'r32', date: '2026-07-01', time: '12:00', timezone: 'America/New_York', stadiumId: 'mercedes-benz-stadium' },
  { id: 81, round: 'r32', date: '2026-07-01', time: '17:00', timezone: 'America/Los_Angeles', stadiumId: 'levis-stadium' },
  { id: 82, round: 'r32', date: '2026-07-01', time: '13:00', timezone: 'America/Los_Angeles', stadiumId: 'lumen-field' },
  { id: 83, round: 'r32', date: '2026-07-02', time: '19:00', timezone: 'America/Toronto', stadiumId: 'bmo-field' },
  { id: 84, round: 'r32', date: '2026-07-02', time: '12:00', timezone: 'America/Los_Angeles', stadiumId: 'sofi-stadium' },
  { id: 85, round: 'r32', date: '2026-07-02', time: '20:00', timezone: 'America/Vancouver', stadiumId: 'bc-place' },
  { id: 86, round: 'r32', date: '2026-07-03', time: '18:00', timezone: 'America/New_York', stadiumId: 'hard-rock-stadium' },
  { id: 87, round: 'r32', date: '2026-07-03', time: '20:30', timezone: 'America/Chicago', stadiumId: 'arrowhead-stadium' },
  { id: 88, round: 'r32', date: '2026-07-03', time: '13:00', timezone: 'America/Chicago', stadiumId: 'att-stadium' },
