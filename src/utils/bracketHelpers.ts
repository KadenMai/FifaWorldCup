...
const KNOCKOUT_FIXTURES: BracketFixture[] = [
  ...
  { id: 75, round: 'r32', date: '2026-06-29', time: '19:00', timezone: 'America/Monterrey', home: { kind: 'winner', group: 'F' }, away: { kind: 'runner-up', group: 'C' } },
  { id: 76, round: 'r32', date: '2026-06-29', time: '12:00', timezone: 'America/Chicago', home: { kind: 'winner', group: 'C' }, away: { kind: 'runner-up', group: 'F' } },
  { id: 77, round: 'r32', date: '2026-06-30', time: '17:00', timezone: 'America/New_York', home: { kind: 'winner', group: 'I' }, away: { kind: 'third', winnerGroup: 'I' } },
  { id: 78, round: 'r32', date: '2026-06-30', time: '12:00', timezone: 'America/Chicago', home: { kind: 'runner-up', group: 'E' }, away: { kind: 'runner-up', group: 'I' } },
  { id: 79, round: 'r32', date: '2026-06-30', time: '19:00', timezone: 'America/Mexico_City', home: { kind: 'winner', group: 'A' }, away: { kind: 'third', winnerGroup: 'A' } },
  { id: 80, round: 'r32', date: '2026-07-01', time: '12:00', timezone: 'America/New_York', home: { kind: 'winner', group: 'L' }, away: { kind: 'third', winnerGroup: 'L' } },
  { id: 81, round: 'r32', date: '2026-07-01', time: '17:00', timezone: 'America/Los_Angeles', home: { kind: 'winner', group: 'D' }, away: { kind: 'third', winnerGroup: 'D' } },
  { id: 82, round: 'r32', date: '2026-07-01', time: '13:00', timezone: 'America/Los_Angeles', home: { kind: 'winner', group: 'G' }, away: { kind: 'third', winnerGroup: 'G' } },
  { id: 83, round: 'r32', date: '2026-07-02', time: '19:00', timezone: 'America/Toronto', home: { kind: 'runner-up', group: 'K' }, away: { kind: 'runner-up', group: 'L' } },
  { id: 84, round: 'r32', date: '2026-07-02', time: '12:00', timezone: 'America/Los_Angeles', home: { kind: 'winner', group: 'H' }, away: { kind: 'runner-up', group: 'J' } },
  { id: 85, round: 'r32', date: '2026-07-02', time: '20:00', timezone: 'America/Vancouver', home: { kind: 'winner', group: 'B' }, away: { kind: 'third', winnerGroup: 'B' } },
  ...
  { id: 87, round: 'r32', date: '2026-07-03', time: '20:30', timezone: 'America/Chicago', home: { kind: 'winner', group: 'K' }, away: { kind: 'third', winnerGroup: 'K' } },
  { id: 88, round: 'r32', date: '2026-07-03', time: '13:00', timezone: 'America/Chicago', home: { kind: 'runner-up', group: 'D' }, away: { kind: 'runner-up', group: 'G' } },
